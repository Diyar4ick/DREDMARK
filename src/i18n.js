...
const resources = {
  ru: {
    translation: {
      ...
      vozmSection10Text1: "Устройства заграждения переезда — комплект устройств, предназначенных для автоматического ограждения проезжей части на железнодорожных переездах путём поднятия установленного на шарнирах заграждающего элемента (крышки). УЗП устанавливается в количестве 4 или 8 отдельных устройств (в зависимости от ширины проезжей части), ширина поднимающихся крышек — от 3,5 до 5 метров.",
      vozmSection10Text2: "Основные части устройства заграждения переезда (УЗП):",
      vozmSection10List1: "фундамент — основание, на которое установлены каркас и крышка УЗП;",
      vozmSection10List2: "поднимающиеся крышки — прямоугольные рамы, установленные на шарнирные опоры, и имеющие с обратной стороны светоотражающие элементы; крышки поднимаются на угол до 30°;",
      vozmSection10List3: "электропривод — передаёт крутящий момент на брусья с установленными на них крышками;",
      vozmSection10List4: "датчики обнаружения транспортных средств (датчики контроля занятости крышки (КЗК));",
      vozmSection10List5: "противовес — фиксирует крышки УЗП в закрытом или открытом положении;",
  ...
  en: {
    translation: {
      ...
      vozmSection10Text1: "Railway crossing barrier devices — a set of devices designed to automatically block the roadway at railway crossings by raising a hinged barrier element (lid). The UZP is installed in quantities of 4 or 8 individual units (depending on the width of the roadway), the width of the rising lids ranges from 3.5 to 5 meters.",
      vozmSection10Text2: "Main components of the railway crossing barrier device (UZP):",
      vozmSection10List1: "foundation — the base on which the UZP frame and lid are mounted;",
      vozmSection10List2: "rising lids — rectangular frames mounted on hinged supports, with reflective elements on the back side; lids rise at an angle up to 30°;",
      vozmSection10List3: "electric drive — transmits torque to the beams with the attached lids;",
      vozmSection10List4: "vehicle detection sensors (lid occupancy control sensors - KZK);",
      vozmSection10List5: "counterweight — holds the UZP lids in closed or open position;",
  ...
  uz: {
    translation: {
      ...
      vozmSection10Text1: "Temir yo‘l o‘tish joyi to‘siq qurilmalari — temir yo‘l o‘tish joylarida yo‘l qismini avtomatik ravishda to‘sib qo‘yish uchun mo‘ljallangan qurilmalar to‘plami, bunda menteşali to‘siq elementi (qopqoq) ko‘tariladi. UZP yo‘l qismining kengligiga qarab 4 yoki 8 ta alohida qurilmadan iborat bo‘ladi, ko‘tariluvchi qopqoqlarning kengligi 3,5 metrdan 5 metrgacha.",
      vozmSection10Text2: "Temir yo‘l o‘tish joyi to‘siq qurilmasining (UZP) asosiy qismlari:",
      vozmSection10List1: "poydevor — UZP karkasi va qopqog‘i o‘rnatilgan asos;",
      vozmSection10List2: "ko‘tariluvchi qopqoqlar — menteşali tayanchlarga o‘rnatilgan to‘rtburchak ramkalar, orqa tomonida yorug‘lik aks ettiruvchi elementlar mavjud; qopqoqlar 30° burchakka ko‘tariladi;",
      vozmSection10List3: "elektr uzatma — qopqoqlar o‘rnatilgan to‘sinlarga aylanish momentini uzatadi;",
      vozmSection10List4: "transport vositalarini aniqlash datchiklari (qopqoq bandligini nazorat qiluvchi datchiklar - KZK);",
      vozmSection10List5: "qarshi vazn — UZP qopqoqlarini yopiq yoki ochiq holatda ushlab turadi;",
